    ...
    quotes: [
      {
        ...
        original: 'If in the first act you have hung a pistol on the wall, then in the following one it should be fired.',
        originalLang: 'en',
        originalLocale: 'en',
      ...
      },
      {
        ...
        original: 'Knowledge is of no value unless you put it into practice.',
        originalLang: 'ru',
        originalLocale: 'en',
      ...
      },
      {
        ...
        original: 'People don\'t notice whether it\'s winter or summer when they\'re happy.',
        originalLang: 'ru',
      ...
      },
      {
        ...
        original: 'The task of a writer is not to solve the problem but to state the problem correctly.',
        originalLang: 'ru',
        source: { en: 'Letter to Alexei Suvorin', zh: '致阿列克谢·苏沃林的信' },
        year: 1888,
      },
